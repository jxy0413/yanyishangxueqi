...
public interface ConfigI {
    ...
    // 邮件接收者
    String[] ADMIN_MAIL = {"15011006250@163.com", "18813035277@163.com"};

    // 相爱时间：年，月，日
    int TIME_LOVE_YEAR = 2016;
    ...
    String FIRST_PAGE_TITLE_SECONDARY = "贾相宇 &nbsp; ❤ &nbsp; 李怡陶";
    String FIRST_PAGE_TIME_LOVE = "2016-11-11";
    String FIRST_PAGE_CONTACT_QQ = "964078918";
    String FIRST_PAGE_COPY_RIGHT = "CopyRight © 2015-";
    String FIRST_PAGE_ADMIN_MESSAGE = "欢迎访问，欢迎观看，欢迎留言";
    String FIRST_PAGE_KEYWORDS = "我们的小窝,贾相宇,李怡陶";
