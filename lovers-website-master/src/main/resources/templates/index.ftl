...
<html lang="zh-CN">
<head>
    <embed src="chengdu.mp3" autostart="true" loop="true"></embed>
  <meta charset="utf-8" />
...
<div class="main bg-pink">
  ...
  <div id="picture" class="container">
    ...
    <div class="row">
      <div class="col-6 col-sm-6 col-lg-3">
        <div class="card">
          <a href="//39.105.50.119:8082/3D.html"target="_blank">
      ...
      <div class="col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3">
        <div class="card">
          <a href="//39.105.50.119:8082/xuanzhuan.html" target="_blank">
            <img class="img-thumbnail rounded card-img-top" src="image/index/2.jpg" alt="旋转相册">
          </a>
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              <a href="//39.105.50.119:8082/xuanzhuan.html" target="_blank" class="btn btn-sm btn-link text-muted"> 旋转相册 </a>
            </div>
          </div>
        </div>
      </div>
      <div class="col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3">
        <div class="card">
          <a href="//39.105.50.119:8082/mefang.html" target="_blank">
            <img class="img-thumbnail rounded card-img-top" src="image/index/3.jpg" alt="魔方相册">
          </a>
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              <a href="//39.105.50.119:8082/mefang.html" target="_blank" class="btn btn-sm btn-link text-muted"> 魔方相册 </a>
            </div>
          </div>
        </div>
      </div>
      <div class="col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3">
        <div class="card">
          <a href="//static.fengyunxiao.cn/nest/photos/wall/index.html" target="_blank">
            <img class="img-thumbnail rounded card-img-top" src="image/index/4.jpg" alt="未完待续的相册">
          </a>
          <div class="card-body">
            <div class="d-flex justify-content-between align-items-center">
              <a href="//static.fengyunxiao.cn/nest/photos/wall/index.html" target="_blank" class="btn btn-sm btn-link text-muted"> 未完待续的相册 </a>
            </div>
          </div>
        </div>
      </div>
  ...
  <div id="story" class="container">
    ...
    <div class="row">
      <div class="col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3">
        <div class="card">
          <a href="//39.105.50.119:8082/shijian.html" target="_blank">
            <img class="img-thumbnail rounded card-img-top" src="image/index/5.jpg" alt="不灵不灵">
          </a>
          <div class="card-body">
            <a href="//39.105.50.119:8082/shijian.html" target="_blank" class="btn btn-sm btn-link text-muted">Time of Love</a>
          </div>
        </div>
      </div>
      <div class="col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3">
        <div class="card">
          <a href="//39.105.50.119:8082/word.html" target="_blank">
            <img class="img-thumbnail rounded card-img-top" src="image/index/6.jpg" alt="不灵不灵">
          </a>
          <div class="card-body">
            <a href="//39.105.50.119:8082/word.html" target="_blank" class="btn btn-sm btn-link text-muted">Word of Love</a>
          </div>
        </div>
      </div>
      <div class="col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3">
        <div class="card">
          <a href="//39.105.50.119:8082/xuancai.html" target="_blank">
            <img class="img-thumbnail rounded card-img-top" src="image/index/7.jpg" alt="不灵不灵">
          </a>
          <div class="card-body">
            <a href="//39.105.50.119:8082/xuancai.html" target="_blank" class="btn btn-sm btn-link text-muted">Years of Love</a>
          </div>
        </div>
      </div>
      <div class="col-6 col-sm-6 col-md-6 col-lg-3 col-xl-3">
        <div class="card">
          <a href="//39.105.50.119:8082/shu.html" target="_blank">
            <img class="img-thumbnail rounded card-img-top" src="image/index/8.jpg" alt="不灵不灵">
          </a>
          <div class="card-body">
            <a href="//39.105.50.119:8082/shu.html" target="_blank" class="btn btn-sm btn-link text-muted">Lover of Love</a>
          </div>
        </div>
      </div>
    </div>
