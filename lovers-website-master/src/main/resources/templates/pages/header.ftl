    ...
    <div class="container">
      <div class="row">
        <div class="col-sm-8 col-md-7 py-3">
          <h4>关于：我们的小窝</h4>
          <p class="text-muted">This nest blongs to 贾相宇 and 李怡陶<br />Loved for ${firstPage.loveTotalDays} days, Thanks for your visit. </p>
        </div>
        <div class="col-sm-4 offset-md-1 py-3">
          ...
          <ul class="list-unstyled">
            ...
            <li><a href="https://weibo.com/u/6240079150/home?wvr=5#_loginLayer_1568619305010" target="_blank" class="text-muted">贾微博</a> <a href="https://weibo.com/u/5862228504?is_hot=1" target="_blank" class="text-muted">陶微博</a></li>
          </ul>
        </div>
      </div>
    </div>
